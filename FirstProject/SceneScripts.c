...
const SCENE_SCRIPT const gSceneScriptTable[TOTAL_SCENE_SCRIPTS][MAX_MOVEMENT_SCRIPTS] =
{
	...
	[PREVENT_PROFESSOR_SCRIPT] = { {.Script = START_OF_SCRIPT, .Actor = 0xFF}, {.Script = FACE_DOWN, .Actor = 9}, {.Script = DIALOGUE_TRIGGER, .Actor = 9}, {.Script = DELAY_32, .Actor = 9}, {.Script = FACE_RIGHT, .Actor = 9 }, { .Script = END_OF_SCRIPT, .Actor = 0xFF } },
